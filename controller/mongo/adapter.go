...
func ListCustomerAdapter(c *fiber.Ctx) error {
...
// var CreateDemoQueueAdapter = queue.CreateQueueAdapter(myQueue)

// var CreateDemoJobAdapter = job.CreateJobAdapter(myJob)
